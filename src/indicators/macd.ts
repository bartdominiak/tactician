...
function calculateEMA(data: OHLCData[], period: number): number[] {
...
export function macd(ohlcData: OHLCData[], shortPeriod: number = 12, longPeriod: number = 26, signalPeriod: number = 9): number[] {
